...
function OurStories() {
  return (
    <>
      ...
      <a target="_blank" href="https://www.google.com/maps/place/45+Artashesyan+St,+Yerevan/@40.1531088,44.4782083,18.92z/data=!4m6!3m5!1s0x406abc26aa92ed0b:0x5face05d990d39b2!8m2!3d40.1533711!4d44.4783479!16s%2Fg%2F11c24dzw6n" className={style.weAreFooter}>
        <div>
          <img src={map} alt="" />
        </div>
        <h2>Open Map</h2>
