  ...
  return (
    <>
      ...
      <div className={style.serviceFooter}>
        <div id="carouselExampleIndicators" className="carousel slide container d-flex justify-content-center">
          ...
          >
            <span className={`carousel-control-prev-icon ${style.prev}`} aria-hidden="true" ></span>
          ...
          <button
            ...
            data-bs-slide="next"
          >
            <span className={`carousel-control-next-icon ${style.next}`} aria-hidden="true"></span>
