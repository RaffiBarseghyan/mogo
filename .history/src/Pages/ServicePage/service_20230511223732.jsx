    ...
    <>
      ...
      <div className={style.serviceFooter}>
        <div id="carouselExampleIndicators" className="carousel slide">
          ...
          >
            <span className={`carousel-control-prev-icon ${style.arrow}`} aria-hidden="true" ></span>
            <span className="visually-hidden"{`carousel-control-prev-icon ${style.arrow}`}>Previous</span>
          </button>
          <button
